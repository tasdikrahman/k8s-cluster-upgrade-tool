...
```
$ ./k8sclusterupgradetool component version set valid-cluster-name coredns coredns-component-version
Setting kubernetes context to valid-cluster-name
2022/02/10 12:41:06 coredns has been set to coredns-component-version in cluster

$ ./k8sclusterupgradetool component version set valid-cluster-name aws-node aws-component-version
Setting kubernetes context to valid-cluster-name
